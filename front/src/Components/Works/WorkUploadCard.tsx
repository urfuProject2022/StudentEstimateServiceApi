...
import {animatedStyleWithColor, RoundedStyle} from "../../Styles/SxStyles";
                        ...
                        <Stack direction={"row"} spacing={2}>
                            ...
                            <Stack maxWidth={"58%"} spacing={2} sx={{flexBasis: "58%"}}>
                                {isEnabled ? <>
                                    ...
                                    </Dropzone></> : (work != undefined ? <WorkStatistics workId={work.workId}/> : <></>)
                                }
                                <AttachmentsCard selectedFiles={selectedFiles} onDelete={file => onDelete(file)}
                                                 isDeletable={isEnabled}/>
                            </Stack>
                        </Stack>
